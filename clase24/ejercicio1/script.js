...
const main = async () => {
  ...
  // Se define la ventana de despliegue gl.viewport(0, 0, gl.canvas.width, gl.canvas.height); Paso 2: Se crean, compilan y enlazan los programas Shader               */
  compilaEnlazaLosShaders();

  let jsonCubo = await loadFromJSON("arbol.json");
  /* Paso 3: Se define la geometría y se almacenan en los buffers de memoria.*/
  textura = new Cubo(gl, jsonCubo);
